...
session_start();
    ...
    $db_name = "stu"; // Database name
        ...
        $sql = "CREATE TABLE ".$grname."(student_id int(4) NOT NULL, fname varchar(65) NOT NULL, lname varchar(65) NOT NULL, num int(7) NOT NULL DEFAULT '0', mail varchar(65) NOT NULL, dg varchar(25) NOT NULL, yr VARCHAR (25) NOT NULL, password VARCHAR (250) NOT NULL, perm_id int(1) NOT NULL);";
